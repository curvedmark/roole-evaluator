...
SelectorJoiner.prototype.visit_selectorList = function (selList) {
	if (!this.ancestorSelectorList) return this.visit(selList.children);
	...
	ancSels.forEach(function (ancSel, i) {
		...
		var sels = selList.children;
		if (i !== last) sels = Node.clone(sels, false);

		children = children.concat(this.visit(sels));
	}, this);
